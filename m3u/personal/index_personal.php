...
<head>
    ...
    <title>Hier kyk ons belankrike stront</title>
</head>
...
<style>
    ...
    .hero {
        background: url('/iptv/images/fanart.png') no-repeat;  /* should be: no-repeat center center; vir background center */
    ...
    <header>
	    <div class='hero'>
            <div text-align: left; class='hero-text'>
                <a class='txt2' href="generate_embed_links.php">Watch in browser. Channel list</a></div>
            </div>
        </div>
    </header>
<div>
...
<br>
<p><a href='personal-channels.m3u' class='txt3'>Download: Hele Playlist (alle Bo-genoemde kanale)</a></p>
<br>
<br>
<a class='txt1' href='/'>Home</a>
<br>
<footer>
<a href='/login_system/main.html' style="color: red;"><h5>Daar waar die viruse uithang</h5></a>
</footer>
